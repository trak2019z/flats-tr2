...
/**
 * @ORM\Entity(repositoryClass="App\Repository\FlatPreferenceRepository")
 */
class FlatPreference
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Flat", mappedBy="preferences")
     */
    private $flats;
